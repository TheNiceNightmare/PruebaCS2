...
public class HomeController : Controller
{
    ...
    {
        return RedirectToAction("Index", "Seguro"); // Redirige a la acción Index en el controlador Seguro
    }

    public IActionResult Asegurados()
    {
        return RedirectToAction("Index", "Asegurado"); // Redirige a la acción Index en el controlador Asegurado
    }
}
